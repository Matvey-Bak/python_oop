...
## Getter and setter
Гетерры и сеттеры нужны чтобы дать контролируемый доступ пользователю к атрибутам. Также благодаря геттарам и сеттерам мы можем обращаться к переменным как к атрибутам а не методам
