...
class Order:
    ...
    def __init__(self, name: str, email: str, id_order: int, 
        ...
        self._order_amount: float = order_amount
    ...
    def verify_pin(self, new_pin: str) -> Optional[bool]:
    ...
    def pay_order(self, pin_check: str) -> str:
